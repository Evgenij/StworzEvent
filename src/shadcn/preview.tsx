							...
							<FieldLabel htmlFor="kubernetes-r2h">
								<Field orientation="horizontal">
									<FieldContent>
										...
										<FieldDescription>
											Run GPU workloads on a K8s
											configured cluster. This is the
											default.
										</FieldDescription>
									</FieldContent>
									<RadioGroupItem
							...
							<FieldLabel htmlFor="vm-z4k">
								<Field orientation="horizontal">
									<FieldContent>
										...
										<FieldDescription>
											Access a VM configured cluster to
											run workloads. (Coming soon)
										</FieldDescription>
									</FieldContent>
									<RadioGroupItem
										value="vm"
				...
				<CardHeader>
					...
					<CardAction>
						<DropdownMenu>
							...
							<DropdownMenuContent
								align="end"
								className="w-max style-maia:w-56 style-mira:w-48 style-nova:w-48 style-vega:w-56 style-lyra:w-48"
							>
								<DropdownMenuGroup>
