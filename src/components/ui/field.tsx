...
function FieldLabel({
	...
	return (
		<Label
			...
			className={cn(
				"pl-2  has-data-checked:bg-primary/5 has-data-checked:border-primary dark:has-data-checked:bg-primary/10 gap-2 group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:px-3 *:data-[slot=field]:py-2.5 group/field-label peer/field-label flex w-fit leading-snug",
