...
import { FreeMethodSchemaInput } from "../../schemas/payment/free-method.schema";

export const updateFreeMethodAction = safeAction(
	async (data: FreeMethodSchemaInput) => {
		...
		await prisma.organization.update({
			...
			data: {
				freeInstructions: data.instructions ?? null,
			},
		});
