...
import { ExternalLinkMethodSchemaInput } from "../../schemas/payment/external-link-method.schema";

export const updateExternalLinkMethodAction = safeAction(
	async (data: ExternalLinkMethodSchemaInput) => {
		...
		await prisma.organization.update({
			...
			data: {
				...
				externalLinkInstructions: data.instructions ?? null,
			},
		});
